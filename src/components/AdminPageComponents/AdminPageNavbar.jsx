...
const AdminPageNavbar = () => {
  ...
  const linkStyle = ({ isActive }) => ({
    color: isActive ? '#F56347' : 'white', // Терракотовый для активного, белый для обычного
      ...
      >
        <Box p={5}>
          <Flex justifyContent="space-between" alignItems="center" w="100%" mb={5}>
            <Link to="/admin" >
              <Heading size="md" color=".300" _hover={{ color: 'blue.500', cursor: 'pointer' }}>Админ Панель</Heading>
            </Link>
          ...
          <Stack as="nav" spacing={4}>
            ...
            <NavLink to="/admin/comments" style={linkStyle}>Товары и Комментарии</NavLink>
